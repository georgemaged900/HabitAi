"""
Receipt Scanner — Google Gemma 4 31B (Free)
-------------------------------------------------
Uses Google's Gemma 4 31B multimodal model on OpenRouter.
Larger than NVIDIA's 12B — smarter and better Arabic support, but slower.
No credits needed — completely free.

Model: google/gemma-4-31b-it:free
  - Free on OpenRouter (no credits, no card)
  - 31B parameters — larger and more accurate than NVIDIA's 12B
  - Strong Arabic + English understanding (Google model)
...
MODEL = "google/gemma-4-31b-it:free"   # free, no credits needed
...
def scan_with_gemma(image_path: str) -> Receipt:
...
if __name__ == "__main__":
    print(f"=== PurchaseBuddy — Gemma 4 31B Scanner (Free): {IMAGE_PATH} ===\n")
    ...
    print("Sending image to Gemma 4 31B (free)...")
    receipt = scan_with_gemma(IMAGE_PATH)
